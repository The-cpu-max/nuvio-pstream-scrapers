...
// Returns direct stream links via PrimeSrc API
    ...
    .then(function(info) {
      ...
      return makeRequest(url)
        ...
        .then(function(data) {
          ...
          // Fetch direct links for each server
          var linkPromises = data.servers
            .filter(function(server) { return server.name && server.key; })
            .map(function(server) {
...
if (typeof module !== "undefined" && module.exports) {
  ...
  global.PrimeSrcScraperModule = { getStreams: getStreams };
}
